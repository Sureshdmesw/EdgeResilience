...
cpu_path = Path(
    r"E:\EdgeResilience\artifacts\phase10\qualcomm_inference\cpu_layernorm2_outputs.npy"
)

hw_path = Path(
    r"E:\EdgeResilience\artifacts\phase10\qualcomm_inference\layernorm2_snapdragon\dataset-d9yzw5gv7.h5"
)
